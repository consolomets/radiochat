...
#define devicename "radio.chat.a1"
...
void battery() {
  ...
  char buff[] = "DD.MM.YYYY hh:mm:ss";
  String debugtime = now.toString(buff);
  debuginfo += debugtime + " " + String(battlevel) + " Temperature: " + rtc.getTemperature() + "C </body></html>";
  server.send(200, "text/html", debuginfo);
}
...
void temp(){
    String contenttemp = "Temperature: ";
    contenttemp += rtc.getTemperature();
    contenttemp += " C";
    server.send(200, "text/html", contenttemp);
}
